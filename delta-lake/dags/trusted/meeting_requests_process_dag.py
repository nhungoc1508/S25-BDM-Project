...
with DAG(dag_id="meeting_requests_processing",
    ...
    process_task = SparkSubmitOperator(
        task_id="submit_meeting_requests_process_job",
        application="/opt/airflow/spark/trusted/counseling/process_requests.py",
