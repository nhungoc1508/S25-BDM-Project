...
with DAG(dag_id="sis_dimension_tables_ingestion",
    ...
    task_ingest_dim_tables = SparkSubmitOperator(
        task_id="submit_task_ingest_dim_tables",
        application="/opt/airflow/spark/landing/ingest_sis_dimension_tables.py",
        conn_id="spark-default",
        application_args=[],
        conf=spark_configs
    )

    task_ingest_dim_tables